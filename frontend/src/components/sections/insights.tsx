      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {insights.posts.map((post, i) => (
          <Reveal key={post.title} delay={i * 0.08}>
            <article className="group flex h-full flex-col overflow-hidden rounded-card border border-hairline bg-white transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-brand/5">
