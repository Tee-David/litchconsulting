...
import { Menu, Search, LogOut, Home, Bell, UserPlus, Send, CheckCircle2 } from "lucide-react";
...
const NOTIF_ICON = { lead: UserPlus, invoice_sent: Send, invoice_paid: CheckCircle2 } as const;
