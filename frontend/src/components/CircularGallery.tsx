...
// Ported from the provided ogl CircularGallery component (instructions.txt),
// typed lightly for TypeScript. Behaviour is unchanged.
    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          // Flat at rest, with only a gentle ripple while scrolling — keeps
          // labels crisp and the motion smooth rather than springy.
          p.z = (sin(p.x * 4.0 + uTime) * 1.5 + cos(p.y * 2.0 + uTime) * 1.5) * (abs(uSpeed) * 0.12);
