...
import { ColorPicker, ColorPickerPanel } from "@/components/ui/shadcn/color-picker"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
import { Group, GroupSeparator, GroupText } from "@/components/ui/shadcn/group"
...
import { ToggleGroup, ToggleGroupItem } from "@/components/ui/shadcn/toggle"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
} from "@/components/ui/shadcn/xlsx-viewer"
      ...
      >
        ...
        <DropdownMenuSub>
          <DropdownMenuSubTrigger>
            ...
            Border color
            <span
              className="h-3 w-5 rounded-full border border-hairline"
              style={{ backgroundColor: borderColor }}
            />
          </DropdownMenuSubTrigger>
          <DropdownMenuSubContent
...
function EditorToolbar({
  ...
  return (
    <div className="border-b bg-paper">
      ...
      <TooltipProvider>
        <div className="flex min-h-12 flex-wrap items-center gap-2 border-b bg-paper px-3 py-2">
          <div className="flex shrink-0 items-center gap-1">
        ...
        <div className="border-t bg-paper px-2 py-1">
...
export function XlsxEditorSurface({
  ...
  return (
    <div
      className={cn(
        "flex h-[640px] min-h-0 flex-col overflow-hidden bg-paper",
        className
      )}
    >
      <EditorToolbar
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        <div className="min-h-0 flex-1 bg-surface/20">
          <XlsxViewer
            ...
            fileTooLargeState={
              <div className="grid h-full w-full min-w-full place-items-center p-6">
                <div className="max-w-sm rounded-lg border bg-paper p-4 text-sm">
            ...
            errorState={
              <div className="grid h-full w-full min-w-full place-items-center p-6 text-sm text-red-500">
  ...
  if (!url && !uploadedWorkbook) {
    return (
      ...
      >
        ...
        />
        <div className="grid min-h-0 flex-1 place-items-center bg-surface/30 p-4">
          <div className="max-w-md rounded-lg border bg-paper p-4 text-center text-sm shadow-xs">
  ...
  if (loadError && !activeBuffer) {
    return (
      ...
      >
        ...
        />
        <div className="grid min-h-0 flex-1 place-items-center bg-surface/30 p-4">
          <div className="max-w-md rounded-lg border bg-paper p-4 text-sm">
