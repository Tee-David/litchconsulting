...
function WorkbookToolbar({
  ...
  return (
    <div className="flex min-h-12 flex-wrap items-center justify-end gap-2 border-b bg-paper px-3 py-2">
      <TooltipProvider>
...
const WorkbookSheetTabsInner = React.memo(function WorkbookSheetTabsInner({
  ...
  return (
    <div
      className="border-t bg-surface/40 px-3 py-2"
    ...
    >
      ...
      previewUrl
        ? createPortal(
            <div
              className="pointer-events-none fixed z-40 translate-y-0 overflow-hidden rounded-lg border bg-paper/95 opacity-100 shadow-xl backdrop-blur-md transition-[opacity,transform] duration-100"
              style={{
            ...
            >
              <div className="relative aspect-[11/7] w-full overflow-hidden bg-surface/60">
