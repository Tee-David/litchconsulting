  ...
  return (
    <div className={cn("space-y-1.5", className)}>
      ...
      <input
        ...
        value={hsl[0]}
        aria-label="Hue"
        className="h-3 w-full cursor-pointer appearance-none rounded-full border border-hairline bg-transparent ink"
        style={{
          background:
        ...
        {COLOR_PICKER_PRESETS.map((preset) => {
          ...
          return (
            <button
              ...
              type="button"
              className={cn(
                "grid size-6 place-items-center rounded-full border shadow-xs transition-transform hover:scale-110 focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none",
            ...
            >
              {selected ? (
                <HugeiconsIcon
                  ...
                  className={cn(
                    "size-3.5",
                    preset === "#ffffff" ? "text-ink" : "text-white"
                  )}
                />
              ) : null}
            </button>
