            ...
            {services.map((s) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6">
                  <span className="text-xs font-semibold uppercase tracking-[0.14em] text-brand dark:text-highlight">
                    {s.kind}
                  </span>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-body">{s.tagline}</p>
                </div>
              </Link>
            ))}
          </div>
